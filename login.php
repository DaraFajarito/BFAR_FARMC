...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	//Define default usernames for farmc organization
	$farmc_username = 'FARMC';
	$farmc_password = 'farmc123';

	// Check if the provided credentials match the default values
    if ($username === $defaultUsername && $password === $defaultPassword) {
        // Successful login, set a success message
					...
					<div class="login-card card-block">
						<form class="md-float-material">
							<div class="text-center">
								<img src="./../BFAR_FARMC/img/logo.webp" style="width:60px; height:60px;" alt="logo">
							</div>
							<h3 class="text-center txt-primary">
								Good day! Please log in
							</h3>
							<div class="row">
								<div class="col-md-12">
